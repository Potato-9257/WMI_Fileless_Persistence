...
function Install-Persistence{
    ...
    $EventFilterArgs = @{
        ...
        Query = "SELECT * FROM __InstanceModificationEvent WITHIN 60 WHERE TargetInstance ISA 'Win32_PerfFormattedData_PerfOS_System' AND TargetInstance.SystemUpTime >= 10 AND TargetInstance.SystemUpTime < 325"
        QueryLanguage = 'WQL'
    }
